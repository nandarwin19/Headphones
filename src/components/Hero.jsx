    ...
    <div id="main" className="h-screen pt-[10vh] bg-white1 flex  w-full">
      <div className="grid laptop:grid-cols-12 w-full">
        ...
        <div className="col-span-3  h-[80vh]">
          <div className="w-full  transform-origin-top border two-text-bg border-b-black border-r-0 flex flex-col justify-between min-h-[280px]  p-4 py-6 h-[20vh]">
      ...
      <div className="moving-text-container bg-white1  border-2 border-black border-r-0 absolute bottom-5 flex items-center w-full h-12 tablet:h-20">
